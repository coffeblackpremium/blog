<template>
    ...
    border-gray-200 dark:border-gray-800 shadow-lg">
        <div class="container flex flex-wrap items-center justify-between mx-auto md:max-w-3xl">
            <Link :href="route('blog.index')" class="flex items-center">
            ...
            <div class="flex flex-reverse items-end justify-end">
                ...
                <button :click="toggleNavbar" aria-controls="navbar-hamburger" aria-expanded="false" class="md:hidden inline-flex items-center p-2 ml-3 text-sm text-gray-500 rounded-lg hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200
            ...
            <div id="navbar-hamburger" class="hidden items-center md:justify-center w-full md:flex md:w-auto md:order-1">
                ...
                md:dark:bg-gray-900 dark:border-gray-700">
                    <li>
                        <Link aria-current="page" class="block py-2 pl-3 pr-4 text-white bg-red-700 rounded md:bg-transparent
               md:text-blue-700 md:p-0 dark:text-white" :href="route('blog.index')">Home</Link>
                    </li>
                    <li>
              ...
              dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent
               dark:border-gray-700" href="#">Sobre mim</a>
                    </li>
                </ul>
            </div>
        </div>
